...
def apply_all_analysis_layers(text_or_answers: Union[str, Dict[str, Any]], lang: str = "العربية") -> Dict[str, Any]:
    ...
    z_drivers: List[str] = []
    try:
        z_drivers = analyze_silent_drivers(answers=answers, lang=lang) if answers else []
...
# ======================
def analyze_user_from_answers(user_id_or_answers, answers: Dict[str, Any] = None, lang: str = "العربية") -> Dict[str, Any]:
    """
    توافُق مع استدعائين:
